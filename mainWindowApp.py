...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btnGetCurrentWeather.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.SplitHCursor))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 764, 352))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_town_graph.setText(_translate("Form", "День"))
